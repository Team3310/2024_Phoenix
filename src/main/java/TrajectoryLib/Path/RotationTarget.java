...
public class RotationTarget {
   ...
   * @param rotateFast               Should the robot reach the rotation as fast
   *                                 as possible
   */
   ...
   *
   * @param targetJson {@link org.json.simple.JSONObject} representing a rotation
   *                   target
   ...
   *
   * <p>
   * For example, a target with position 1.5 for the segment 1 will have the
   * position 0.5
   *
