...
public class Constants {
    ...
    //#region Lift
        ...
        static {
            ...
            kLiftAngleMapComp.put(new InterpolatingDouble(24.0), new InterpolatingDouble(19.5));
            kLiftAngleMapComp.put(new InterpolatingDouble(28.0), new InterpolatingDouble(17.5));
        }
