...
public class CenterOverStartSource extends AutonCommandBase{

    public CenterOverStartSource(RobotContainer robotContainer) {
        ...
        this.addCommands(
            ...
            new ParallelDeadlineGroup(
                Follow(Paths.getInstance().SOURCE_THROUGH), 
