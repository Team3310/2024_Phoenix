...
public class ThreeStageLeftCounter extends AutonCommandBase{
    public ThreeStageLeftCounter(RobotContainer robotContainer){
        super(robotContainer);

        this.addCommands(
            new TwoStageLeft(robotContainer),
            new ParallelDeadlineGroup(
                Follow(Paths.getInstance().THREE_STAGE_COUNTER), 
                new IntakeShooter()
            ),
