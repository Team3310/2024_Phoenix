    ...
    public TestAuton(RobotContainer robotContainer){
        ...
        auton.addSection(
            ...
            new SequentialCommandGroup(
                ...
                new WaitCommand(0.5),
                new InstantCommand(()->SmartDashboard.putNumber("index2", 1.5)),
                new WaitCommand(0.5),
                new InstantCommand(()->SmartDashboard.putNumber("index2", 2.0)),
                new WaitCommand(0.5),
                new InstantCommand(()->SmartDashboard.putNumber("index2", 2.5))
            )
        );
