...
public class TunerConstants {
        public static TunerConstants instance;
        ...
        public final String kSecondaryCANbusName;// = isCompbot ? "Drivetrain" : "rio";
        private static final int kPigeonId = 0;

        public final double liftMagnetOffset;// = isCompbot ? 0.254980390625 : 0.74129667;
        ...
        private final double kFrontLeftEncoderOffset;// = isCompbot ? 0.21923828125 : -0.177001953125;
        ...
        private final double kFrontRightEncoderOffset;// = isCompbot ? 0.053710937 : -0.268798828125;
        ...
        private final double kBackLeftEncoderOffset;// = isCompbot ? -0.231201171875 : 0.146728515625;
        ...
        private final double kBackRightEncoderOffset;// = isCompbot ? 0.464599609375 : 0.091064453125;

        private static final double kBackRightXPosInches = -12.125;
        private static final double kBackRightYPosInches = -12.125;

        private final SwerveModuleConstants FrontLeft;/* = ConstantCreator.createModuleConstants(
                        kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset,
                        Units.inchesToMeters(kFrontLeftXPosInches), Units.inchesToMeters(kFrontLeftYPosInches),
                        kInvertLeftSide); */
        private final SwerveModuleConstants FrontRight; /* = ConstantCreator.createModuleConstants(
        ...
        private final SwerveModuleConstants BackLeft;/* = ConstantCreator.createModuleConstants(
                        kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset,
                        Units.inchesToMeters(kBackLeftXPosInches), Units.inchesToMeters(kBackLeftYPosInches),
                        kInvertLeftSide); */
        private final SwerveModuleConstants BackRight;/* = ConstantCreator.createModuleConstants(
                        kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset,
                        Units.inchesToMeters(kBackRightXPosInches), Units.inchesToMeters(kBackRightYPosInches),
                        kInvertRightSide);*/

        public final Drivetrain DriveTrain;/* = new Drivetrain(DrivetrainConstants, FrontLeft,
                        FrontRight, BackLeft, BackRight);*/

        public static InterpolatingTreeMap<InterpolatingDouble, InterpolatingDouble> kLiftAngleMap;

        public static TunerConstants getInstance(){
                if(instance==null){
                        instance = new TunerConstants(Robot.isCompetitionBot());
                }
                return instance;
        }

        private TunerConstants(boolean isCompbot){
                kSecondaryCANbusName = isCompbot ? "Drivetrain" : "rio";
                liftMagnetOffset = isCompbot ? 0.254980390625 : 0.74129667;

                kFrontLeftEncoderOffset = isCompbot ? 0.21923828125 : -0.177001953125;
                kFrontRightEncoderOffset = isCompbot ? 0.053710937 : -0.268798828125;
                kBackLeftEncoderOffset = isCompbot ? -0.231201171875 : 0.146728515625;
                kBackRightEncoderOffset = isCompbot ? 0.464599609375 : 0.091064453125;

                SmartDashboard.putNumber("kFrontLeftEncoderOffset", kFrontLeftEncoderOffset);
                ...
                DriveTrain = new Drivetrain(DrivetrainConstants, FrontLeft,
                                FrontRight, BackLeft, BackRight);

                
                kLiftAngleMap = isCompbot ? Constants.kLiftAngleMapComp : Constants.kLiftAngleMapPractice;
