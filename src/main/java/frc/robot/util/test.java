...
public class test {
    public static void main(String[] args) {
        ...
        // System.out.println(Constants.kRightShooterMap.getInterpolated(new InterpolatingDouble(12.0)).value);
        // System.out.println(Constants.kLeftShooterMap.getInterpolated(new InterpolatingDouble(12.0)).value);
    }
}
